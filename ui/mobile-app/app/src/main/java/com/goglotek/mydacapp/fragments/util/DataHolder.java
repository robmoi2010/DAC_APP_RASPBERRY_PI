...
public class DataHolder extends RecyclerView.ViewHolder {
  ...
  private CheckBox createCheckBox(boolean checked) {
    com.google.android.material.checkbox.MaterialCheckBox checkBox = new MaterialCheckBox(
        itemView.getContext());
  ...
  private SwitchCompat createSwitch(boolean checked, DataRow row) {
    ...
    defaultSwitch.setThumbDrawable(
        ContextCompat.getDrawable(itemView.getContext(), R.drawable.custom_thumb));
    defaultSwitch.setTrackDrawable(
        ContextCompat.getDrawable(itemView.getContext(), R.drawable.custom_track));
    if (checked) {
