...
class MainOutput(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Label(self, text="Select Main Speakers Output", font=("Arial", 16)).pack(
            pady=20
        )
