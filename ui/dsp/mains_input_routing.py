...
class MainsInputRouting(tk.Frame):
    ...
    def route_on_click(frame, selection, type):
        ...
        if answer:
            router.update_mains_input_sink(type)
            if type == 0:
    ...
    def __init__(self, parent, controller):
        ...
        tk.Label(self, text="Select Mains Input Sink", font=("Arial", 16)).pack(pady=20)
        current_input_sink = router.get_mains_input_sink()
        self.btn1 = tk.Button(
            self,
            relief=RELIEF,
            font=btnFont,
