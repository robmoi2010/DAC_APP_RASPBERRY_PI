...
const DspSettings = () => {
    ...
    const components = [
        ...
        < PaddingRow />,
        <DataRow selected={false} onClick={() => navigate("/Input")} text="Input" type={1} active={index == 0} />,
        <PaddingRow />,
        <DataRow selected={false} onClick={() => navigate("/Output")} text="Output" type={1} active={index == 1} />,
        <PaddingRow />,
        <DataRow selected={false} onClick={() => navigate("/Settings")} text="Back" type={2} active={index == 2} />,
    ];
