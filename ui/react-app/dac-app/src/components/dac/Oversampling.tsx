...
import { getOversamplingStatus, updateOversamplingStatus } from "../../services/DacService";
...
const processData = (data: Promise<responseDataType>, dispatch: Dispatch) => {
    ...
    data.then(dt => {
        ...
        components.push({ key: "1", value: (dt.value == "0") ? "1" : "0", display_name: "Disable(Oversample externally by 8x)", description:"" });
