...
import { getSecondOrderStatus, updateSecondOrderStatus } from "../../services/DacService";
...
const SecondOrderCompensation = () => {
    ...
    useEffect(() => {
        ...
        const status = getSecondOrderStatus();
...
const handleSelection = (selection: number, dispatch: Dispatch) => {
    ...
    const response = updateSecondOrderStatus(JSON.stringify(data))
...
export default SecondOrderCompensation;