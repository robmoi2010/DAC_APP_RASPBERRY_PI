...
const SystemTabs = () => {
    return (
        <Tabs.Root lazyMount unmountOnExit defaultValue="VolumeDevice" orientation="vertical">
            <Tabs.List>
                <Tabs.Trigger value="VolumeDevice">Volume Device</Tabs.Trigger>
                <Tabs.Trigger value="VolumeAlgorithm">Volume Algorithm</Tabs.Trigger>
                <Tabs.Trigger value="SoundModes">Sound Modes</Tabs.Trigger>
            </Tabs.List>
